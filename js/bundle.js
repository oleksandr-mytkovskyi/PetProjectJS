...
function cards() {
  var MenuItem = /*#__PURE__*/function () {
    function MenuItem(src, alt, title, description, price, selector) {
  ...
  Object(_services_services__WEBPACK_IMPORTED_MODULE_5__["getResourses"])('http://localhost:3000/menu').then(function (data) {
...
function form(formSelector, timerModal) {
  ...
  function showThanksModal(message) {
    ...
    Object(_modal__WEBPACK_IMPORTED_MODULE_8__["openModal"])('.modal', timerModal);
...
function closeModal(modalSeceltor) {
  var modal = document.querySelector(modalSeceltor);
...
function modal(triggerSelector, modalSeceltor, modalTimerId) {
  ...
  modalTrigger.forEach(function (elem) {
    elem.addEventListener('click', function () {
      return openModal(modalSeceltor, modalTimerId);
    });
  });
...
function slider(_ref) {
  var container = _ref.container,
      ...
      field = _ref.field;
  // Slaider 
  var sliderElement = document.querySelectorAll(slide),
  ...
  sliderElement.forEach(function (slide) {
...
function tabs(tabsSelector, tabsContentSelector, tabsParentSelector, activeClass) {
  ...
  hideTabContent();
  showTabContent();
  tabsParents.addEventListener('click', function (e) {
    var target = e.target;
...
document.addEventListener('DOMContentLoaded', function () {
  var timerModal = setTimeout(function () {
    return Object(_modules_modal__WEBPACK_IMPORTED_MODULE_1__["openModal"])('.modal', timerModal);
  }, 10000);
  Object(_modules_tabs__WEBPACK_IMPORTED_MODULE_0__["default"])('.tabheader__item', '.tabcontent', '.tabheader__items', 'tabheader__item_active');
  Object(_modules_modal__WEBPACK_IMPORTED_MODULE_1__["default"])('[data-modal]', '.modal', timerModal);
  Object(_modules_timer__WEBPACK_IMPORTED_MODULE_2__["default"])('.timer', '2020-10-23');
      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          ...
          case 2:
            ...
            throw new Error("Could not fethc ".concat(ulr, ", status: ").concat(res.status));
